                ...
                child: Row(
                  ...
                  children: [
                    Image(image: NetworkImage(
                      cubit.healthArticle[index].urlToImage==null?
                      "https://img.freepik.com/free-vector/year-2022-concept-design-stylized-image-2022-happy-anthropomorphic-zero-juggles-twos-vector-illustration_255498-564.jpg?w=826 "
                          :
                      cubit.healthArticle[index].urlToImage,
                    ),
                      height: 150,
                      width: 150,
                      fit: BoxFit.cover,
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(cubit.healthArticle[index].title,
                            ...
                            Divider(),
                            Text(cubit.healthArticle[index].publishedAt,
