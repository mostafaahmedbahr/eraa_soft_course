      ...
      builder: (context,state){
        ...
        return Expanded(
          child: ListView.separated(
            ...
            itemCount: cubit.businessArticle.length,
                ...
                child: Row(
                  ...
                  children: [
                    Image(image: NetworkImage(
                      cubit.businessArticle[index].urlToImage==null?
                      "https://img.freepik.com/free-vector/year-2022-concept-design-stylized-image-2022-happy-anthropomorphic-zero-juggles-twos-vector-illustration_255498-564.jpg?w=826 "
                          :
                      cubit.businessArticle[index].urlToImage,
                    ),
                      height: 150,
                      width: 150,
                      fit: BoxFit.cover,
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(cubit.businessArticle[index].title,
                            ...
                            Divider(),
                            Text(cubit.businessArticle[index].publishedAt,
